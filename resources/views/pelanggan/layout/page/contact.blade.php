...
@section('content')
    <div class="d-flex justify-content-lg-between mt-5">
        <div class="card mb-3 gap-3" style="width: 28rem;">
            ...
            <div class="card-body">
                <h5 class="card-title">@arvndy_</h5>
                <p class="card-text">152023027 Gloryan ArgaVendy</p>
                <a href="https://www.instagram.com/arvndy_/" target="_blank" class="btn btn-primary">Instagram</a>
            </div>
        </div>
        <div class="card mb-3 gap-3" style="width: 28rem;">
            <img src="{{ asset('') }}" class="card-img-top object-fit-cover " style="height: 350px;">
            <div class="card-body">
                <h5 class="card-title">@AmsaTaarigan</h5>
                <p class="card-text">152023120 Amsa Cicio Tarigan</p>
                <a href="https://www.instagram.com/amsatrgsilangit/" target="_blank" class="btn btn-primary">Instagram</a>
            </div>
        </div>
        <div class="card mb-3 gap-3" style="width: 28rem;">
            <img src="{{ asset('') }}" class="card-img-top object-fit-cover " style="height: 350px;">
            <div class="card-body">
                <h5 class="card-title">@deanhanafi</h5>
                <p class="card-text">152023115 Dean Hanafi</p>
